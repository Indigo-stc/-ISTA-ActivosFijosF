...
export class ActivosComponent implements OnInit {
  ...
  caps_nombre_documento(e) {
    ...
    this.new_cap_nombre_documento3 = this.cap_nombre_documento3.slice(2,-2)
    console.log('el id = ' + this.new_cap_nombre_documento3)
  ...
  buscarElNameDoc(): void{
    this.activoServe.buscarIdporNombreDelDoc(this.cap_nombre_documento3).subscribe({
      next: data => {
        ...
        this.cap_id_del_documento = data;
        //this.new_cap_id_del_documento = this.cap_id_del_documento.slice(1, -1)
        console.log('Esta es la id del doc 2 =>' + this.cap_id_del_documento)
      },
      error: err => {
